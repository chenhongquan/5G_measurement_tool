...
# cp_cmp = 'cp ./client_9001.out '+new_verus_result_dir
# os.system(cp_cmp)
...
# cmd = 'python3 '+verus_plot_file+' '+new_verus_result_dir+'/client_9001.out '+new_verus_result_dir+'/Receiver.out  -o '+new_verus_result_dir
# os.system(cmd)
